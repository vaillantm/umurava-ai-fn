  ...
  return (
    <html lang="en" data-scroll-behavior="smooth" className={`${roboto.variable} ${dmMono.variable} ${instrumentSerif.variable}`}>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800&family=Sora:wght@400;500;600;700;800&family=Outfit:wght@700;800;900&family=Syne:wght@400;500;600;700;800&display=swap"
          rel="stylesheet"
        />
        <link
          rel="stylesheet"

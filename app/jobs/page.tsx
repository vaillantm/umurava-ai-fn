          ...
          <div className="job-panel open">
            <div className="job-panel-header">
              <div className="job-panel-heading">
                <div className="job-panel-kicker">{editingId ? 'Refine Job Brief' : 'Create New Opening'}</div>
                <div className="job-panel-title">{editingId ? 'Edit Job Posting' : 'Add Job Posting'}</div>
                <div className="job-panel-subtitle">Capture the role, hiring target, and AI evaluation settings in one polished brief.</div>
              </div>
            ...
            <div className="job-panel-body">
              <div className="job-panel-summary">
                <div className="job-panel-stat">
                  <span className="job-panel-stat-label">Mode</span>
                  <strong>{editingId ? 'Editing' : 'New role'}</strong>
                </div>
                <div className="job-panel-stat">
                  <span className="job-panel-stat-label">Shortlist</span>
                  <strong>Top {form.shortlistSize}</strong>
                </div>
                <div className="job-panel-stat">
                  <span className="job-panel-stat-label">AI weights</span>
                  <strong>{totalWeight}% configured</strong>
                </div>
              </div>
              ...
              <section className="job-form-section">
                <div className="job-form-section-head">
                  <h3>Role Details</h3>
                  <p>Define the basics recruiters and the screening engine will use first.</p>
                </div>
              ...
              <section className="job-form-section">
                <div className="job-form-section-head">
                  ...
                  <p>Choose how the shortlist should be generated and how the role should be evaluated.</p>
                </div>
                <div className="job-form-grid">
                  <div className="form-group">
              ...
              <section className="job-form-section">
                <div className="job-form-section-head">
                  <h3>Candidate Fit</h3>
                  <p>Highlight the core skills and describe the kind of candidate you want the AI to prioritize.</p>
                </div>
